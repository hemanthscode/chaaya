/**
 * Series Routes
 * Routes for photo series management
 */
...
} from '../validators/seriesValidator.js';
...
router.post(
  '/',
  validateRequest(validateSeriesCreate),
  createSeries
);

router.put(
  '/:id',
  validateRequest(validateSeriesUpdate),
  updateSeries
);
...
router.put(
  '/:id/reorder',
  validateRequest(validateSeriesReorder),
  reorderSeriesImages
);
